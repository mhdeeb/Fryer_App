# 1 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino"
/*****************************************/
/*****************************************/
...
/*****************************************/
/*****************************************/
# 10 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 2

# 12 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 2
# 13 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 2

# 15 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 2
# 16 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 2
...
u8 Encoder_VidControl(u8 Counter) {
  A_State = digitalRead(9); // Reads the "current" state of the outputA
  // If the previous and the current state of the outputA are different, that means a Pulse has occured
  if (A_State != A_LastState) {
    // If the outputB state is different to the outputA state, that means the encoder is rotating clockwise
    if (digitalRead(10) != A_State) {
      Counter++;
    } else {
      Counter--;
    }
...
# 146 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 3
 (*(volatile uint8_t *)(0x68)) 
# 146 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino"
       |= 1;
  // Select PCINT3 Bit4 = 1 (Pin D11)
  
# 148 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 3
 (*(volatile uint8_t *)(0x6B)) 
# 148 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino"
        |= 14;

  // Reads the initial state of the outputA
  A_LastState = digitalRead(9);
...
# 538 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino" 3
...
# 538 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Fryer_APP.ino"
                {
  if ((SW = digitalRead(11)) == 0x0) {
    while (SW == 0x0) {
      Serial.println(6);
      SW = digitalRead(11);
    }
  ...
  if (((digitalRead(9) == 0x1 || digitalRead(10)) & temp == 1) == 0x1) {
    encoder_value = Encoder_VidControl(encoder_value);
  }

  if (((digitalRead(9) == 0x1 || digitalRead(10)) & temp == 2) == 0x1) {
    Real_counter = 6;
  }

  if (((digitalRead(9) == 0x1 || digitalRead(10)) & temp == 3) == 0x1) {
    local_counter_1 = Encoder_VidControl(local_counter_1);
    local_counter = (local_counter_1) / 3;
  }

  if (((digitalRead(9) == 0x1 || digitalRead(10)) & ((temp == 4) || (temp == 5))) == 0x1) {
    timer_counter_1 = Encoder_VidControl(timer_counter_1);
    timer_counter = (timer_counter_1) / 3;
  }

  if (((digitalRead(9) == 0x1 || digitalRead(10)) & temp == 6) == 0x1) {
  ...
  if (((digitalRead(9) == 0x1 || digitalRead(10)) & temp == 10) == 0x1) {
    On_pointer = Encoder_VidControl(On_pointer);
    ON_timer = Start_timer[0] + Start_timer[1];
  }
}
# 1 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\FRYER_APP2.ino"
// /*****************************************/
// /*****************************************/
// /****** By  : Abdelrahman Mohamed ********/
// /****** Date:     7/DEC/2022      ********/
...
//   }
// }
# 1 "c:\\Users\\eldeeb\\Desktop\\Fryer_APP\\Heater_Program.ino"
/*****************************************/
/*****************************************/
/****** By  : Abdelrahman Mohamed ********/
/****** Date:     7/DEC/2022      ********/
